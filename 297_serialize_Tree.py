        ...
        while q:
            ...
            if isinstance(temp, TreeNode):
                ...
                if left_index < len(data):
                    ...
                    if left != "null":
                        temp.left = TreeNode(int(left))
                if right_index < len(data):
                    right = data[right_index]
                    if right != "null":
                        temp.right = TreeNode(int(right))
                q.append(temp.left)
                q.append(temp.right)
                flag = True
                index += 1
